# OCNOTES: lab-05-georeferencing.html

Page title: Lab [NUM]: [TITLE] | GIS Lab Manual

Source page: `C:/Users/sounn/Git/gis/labs/lab-05-georeferencing.html`
...
- (No matching reference sources found by simple term search.)
...
- (No per-concept hits found; consider searching references by synonyms.)

## Proposed adaptation to the book (concrete next edits for another agent)
- Interactive module candidates: (none auto-suggested; see AGENTS.md decision matrix)
