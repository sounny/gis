...
*   **The Medium:** The textbook is not just a reference; it is an *experience*. It must be as visually compelling as the maps we teach students to create.
...
*   **Status:** The infrastructure is ready (`labs/index.html`, `labs/css/lab.css`). Placeholder files exist, but the *content* for each lab needs to be written by a subject matter expert.
...
1.  **Is it Interactive?** If you are writing a paragraph explaining a process, stop. Can you build a JS tool to *show* it instead?
